...
4. 작업 완료 타이밍과 무관하게 유연한 병합이 가능하다.
...
1. 기능 단위로 브랜치를 쪼개고 작은 PR 단위로 작업하기
...
2. `develop`과 주기적인 `rebase` 또는 병합 유지
...
3. 구조 변경이 예상될 경우, 관련 `feature` 브랜치 개발자와 조기 협의
